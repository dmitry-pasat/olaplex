...
INSERT INTO `settings` (`id`, `key`, `value`, `label`, `type`, `group`, `created_at`, `updated_at`) VALUES
(1, 'map_center', '{"lat":41.77131167976407,"lng":-98.349609375,"zoom":2}', 'Default Map Center', 'json', 'Map Settings', 1386177199, 1386177199),
(2, 'map_cluster_colors', '{"low":"rgba(0,60,136,0.7)","middle":"rgba(0,60,136,0.7)","high": "rgba(0,60,136,0.7)"}', 'Map Cluster Colors', 'json', 'Map Settings', 1386177199, 1386177199),
(5, 'map_poli_color', '{"default":"#2693ED","hover":"#ED8A39"}', 'Map Country/State Colors', 'json', 'Map Settings', 1386177199, 1386177199),
(6, 'default_country', 'US', 'Default Country', 'table.countries.iso2', 'Search Settings', 1386177199, 1386177199),
(7, 'max_distance', '50', 'Max Search Radius (Distance)', 'text', 'Search Settings', 1386177199, 1386177199),
(8, 'cp_logo', '../assets/img/cp_logo.png', 'Control Panel Logo URL', 'image', 'General Settings', 1386177199, 1397581903);
...
INSERT INTO `states` (`name`, `short_name`) VALUES
('Alabama', 'AL'),
('Oregon', 'OR'),
('Nevada', 'NV'),
('North Dakota', 'ND'),
...
CREATE TABLE `stores` (
  ...
  `administrative_area_level_2` varchar(255) CHARACTER SET latin1 DEFAULT NULL,
  `administrative_area_level_1` varchar(255) CHARACTER SET latin1 DEFAULT NULL,
  `postal_code` varchar(255) CHARACTER SET latin1 DEFAULT NULL,
  `country` varchar(255) CHARACTER SET latin1 NOT NULL,
  `latitude` varchar(60) CHARACTER SET latin1 NOT NULL,
  `longitude` varchar(60) CHARACTER SET latin1 NOT NULL,
  `hours` text,
  `description` text,
  `created_at` int(11) NOT NULL,
  `updated_at` int(11) NOT NULL,
  ...
  KEY `administrative_area_level_2` (`administrative_area_level_2`),
  KEY `administrative_area_level_1` (`administrative_area_level_1`),
...
CREATE TABLE `users` (
  ...
  `created_at` int(11) NOT NULL,
  `updated_at` int(11) NOT NULL,
  `profile_fields` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `users` (`id`, `first_name`, `last_name`, `username`, `password`, `group`, `email`, `last_login`, `login_hash`, `created_at`, `updated_at`, `profile_fields`) VALUES
(1, 'Super', 'Admin', 'admin', 'YWqmPGH+dOEvOh6pf83a62lzJ1QQLHRMPHhNIaohB3s=', 100, 'admin@admin.com', 1394807852, '10673fc83a031a40923be51f36fa52fda58d6849', 1394675761, 0, 'a:0:{}');
